...
report_patterns = [
    ...
    path('advancedreport/', views.AdvancedReportCreateView.as_view(), name='advancedreport'),
    path('list/', views.Payment_SuccessView.as_view(), name='list'),
    path('detail/<uuid:pk>/', views.RouteFileView.as_view(), name='detail'),
    path('reportview/<uuid:pk>/', views.ReportView.as_view(), name="reportview"),
    ...
    path('diagnosticreportdetail/<uuid:pk>/', views.FullDiagnosticReportView.as_view(), name="diagnosticreportdetail")
]
