...
class ColumnNameValidator:
    def __init__(self):
        ...
        self.column_patterns = {
            ...
            r'id': 'ShipmentID',
            r'date.*ship': 'Date_ship',
            r'origin.*city': 'OriginCity',
            r'city.*origin': 'OriginCity',
            r'from.*city': 'OriginCity',
            r'source.*city': 'OriginCity',
            r'origin.*zip': 'OriginZIP',
            r'zip.*origin': 'OriginZIP',
            r'from.*zip': 'OriginZIP',
            r'source.*zip': 'OriginZIP',
            r'destination.*city': 'DestinationCity',
            r'dest.*city': 'DestinationCity',
            r'to.*city': 'DestinationCity',
            r'target.*city': 'DestinationCity',
            r'destination.*zip': 'DestinationZIP',
            r'dest.*zip': 'DestinationZIP',
            r'to.*zip': 'DestinationZIP',
            r'target.*zip': 'DestinationZIP',
            ...
            r'shipment.*mode': 'ShipmentMode',
            r'mode': 'ShipmentMode',
            r'ship.*mode': 'ShipmentMode',
            r'load.*type': 'LoadType',
            r'type.*load': 'LoadType',
            r'pallet.*count': 'PalletCount',
            r'pallet.*number': 'PalletCount',
            r'count': 'PalletCount',
            r'volume.*cuft': 'Volume_CuFt',
            r'vol.*cuft': 'Volume_CuFt',
            r'volume': 'Volume_CuFt',
            r'cuft': 'Volume_CuFt',
            r'rate.*type': 'RateType',
            r'accessorial.*charges': 'AccessorialCharges',
            r'accessorial.*detail': 'Accessorials_Detail',
            r'detail': 'Accessorials_Detail',
            r'invoice.*date': 'InvoiceDate',
            r'invoice': 'InvoiceDate',
            r'bill': 'InvoiceDate',
            r'payment.*date': 'PaymentDate',
            r'payment': 'PaymentDate',
            r'pay.*date': 'PaymentDate',
            r'currency': 'Currency',
            r'invoice.*currency': 'Currency',
            r'bill.*currency': 'Currency',
            r'commodity.*type': 'CommodityType',
            r'commodity': 'CommodityType'
        }
...
class CityStateNormalizer:
    ...
    def normalize_column(self, col):
        ...
        print("lenght of dieselprices: ", len(dieselprices))
        # print(dieselprices)
