...
class AdvancedReportCreateView(LoginRequiredMixin, View, JsonFormMixin):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if check_report or advanced_report:
            ...
            logireport.user_prompt = narrative
            logireport.system_prompt = analysis
            logireport.save()
...
class FullAdvancedReportView(TemplateView):
    template_name = "logiflex/reports/full_report.html"
